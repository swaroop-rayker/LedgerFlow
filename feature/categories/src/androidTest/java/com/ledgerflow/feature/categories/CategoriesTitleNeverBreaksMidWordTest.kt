 ...
 *
 * `CategoriesScreen` keeps the shared header — `Row(LfScreenTitle(weight = 1f),
 ...
 * "Categories" is one word where "Notification capture" is two and twenty
 * characters.
 *
...
class CategoriesTitleNeverBreaksMidWordTest {
    ...
    fun title_atDefaultFontScale_keepsItsWordsWhole() {
        ...
        assertNoMidWordBreak("Categories")
    }
