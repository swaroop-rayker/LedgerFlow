 ...
 *   app's user-visible identity for a notification. The rule engine matches on
 *   this for SMS and on [packageName] for notifications — the one genuinely
 *   source-specific field, and §5.2 says so explicitly.
